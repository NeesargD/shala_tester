...
class ClassesCardWidget extends StatelessWidget {
  ...
  ClassesCardWidget({required this.image, required this.day, required this.title, required this.style, required this.level,
      required this.duration, required this.language, this.isLock});
    ...
    return SingleChildScrollView(
      ...
      child: Container(
        decoration: BoxDecoration(borderRadius: BorderRadius
          .circular(10),
          boxShadow: [BoxShadow(color: ColorRes.greyIcon, offset: Offset(0,
              5),blurRadius: 10)],
                         ...
                         Row(
                           children: [
                             ...
                             CircleAvatar(
                               ...
                               radius: 10,
                               child: Text('${language.substring(0, 2)}', style:
                               TextStyles.R10FF),
                             ),
                           ],
                         ),
